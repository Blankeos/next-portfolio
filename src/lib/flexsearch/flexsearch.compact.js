...
(function (self) {
  ...
  function E(a, b) {
    ...
    if (
      ...
      (b && (a = F(a, b)),
      this.G && (a = F(a, this.G)),
      this.H && 1 < a.length && (a = F(a, this.H)),
      c || '' === c)
    ) {
      a = a.split(c);
      if (this.filter) {
        ...
        for (let r = 0; r < e; r++) {
          ...
          if (l && d >= this.m && (u || !n[l])) {
            ...
            switch (this.C) {
              ...
              default:
                if (
                  (this.F && (f = Math.min((f / this.F(b, l, r)) | 0, q - 1)),
                  Q(this, n, l, f, a, c),
                  u && 1 < e && r < e - 1)
                )
                  for (
    ...
    if (a && ((a = this.encode('' + a)), (d = a.length), 1 < d)) {
      ...
      for (let n = 0, u = 0, q; n < d; n++)
        if ((q = a[n]) && q.length >= this.m && !c[q])
          if (this.s || f || this.map[q]) (k[u++] = q), (c[q] = 1);
          else return e;
      a = k;
      d = a.length;
    }
  ...
  t.remove = function (a, b) {
    ...
    if (c) {
      if (this.D)
        ...
        R(this.map, a, this.A, this.s),
          this.depth && R(this.l, a, this.o, this.s);
  ...
  function T(a) {
    ...
    for (let d = 0, f, g; d < e.length; d++)
      (f = e[d]),
        ...
        this.I || (c[f] = new O(g, this.register)),
        (this.F[d] = U(f, this.o)),
        (this.h[d] = f);
    if (this.l)
