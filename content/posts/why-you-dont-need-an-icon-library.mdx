...
const nextConfig = {
  ...
  // If you are using next dev --turbo, use this.
  // Can also refer to this if you face issues: https://stackoverflow.com/questions/79329145/how-to-import-svg-icons-in-nextjs-15
  turbopack: {
    rules: {
