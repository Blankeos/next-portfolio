...
Believe it or not, you don't need extra dependencies to add Icons in your App as actual components. Be it <span class="text-orange-500">Svelte</span>, <span class="text-indigo-600">React</span>, or <span class="text-sky-500">SolidJS</span>.

#### I genuinely think this is the BEST way to add icons to any JS frontend
...
## First, find an icon you want to add to your app.
...
## Second, Add to React, SolidJS, or Svelte
...
type MarkerDuotoneProps = {} & SVGProps<SVGSVGElement>;

export default function MarkerDuotone(props: MarkerDuotoneProps) {
    return (
...
Create a new `.tsx` for your icon and extend the props with `JSX.HTMLAttributes<SVGSVGElement>`:

```tsx
// src/assets/icons/marker-duotone.tsx
import { JSX, mergeProps, VoidProps } from 'solid-js';

type MarkerDuotoneProps = {} & JSX.HTMLAttributes<SVGSVGElement>;
...
<p class="text-center">You've reached the end! Thanks for reading! 🥳</p>
